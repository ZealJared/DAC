Prism.languages.arduino = {
    ...
    important: /\b(setup|loop)\b|\b([A-z0-9_-]+)\./gi,
    keyword: /\b(if|else|for|switch|case|while|do|break|continue|return|goto|void|boolean|char|unsigned|int|word|long|short|float|double|string|String|array|static|volatile|const|sizeof|byte)\b/g,
    ...
    number: /\b-?(0b[01]+|0x[\dA-Fa-f]+|\d*\.?\d+([Ee]-?\d+)?)\b/g,
    'attr-value': /\b(Serial|EEPROM|Ethernet|Stream|Keyboard|Mouse|IPAddress|Server|EthernetServer|Client|EthernetClient|Firmata|GSM|GSMVoiceCall|GSM_SMS|GPRS|GSMClient|LiquidCrystal|LiquidCrystal_I2C|SD|Servo|SPI|SoftwareSerial|Stepper|TFT|EsploraTFT|Pimage|WiFi|WiFiServer|WiFiClient|WiFiUDP|Wire)\b/g,
